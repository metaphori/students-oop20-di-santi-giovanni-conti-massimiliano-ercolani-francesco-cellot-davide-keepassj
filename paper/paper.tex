...
Implementazione dei controller per aggiunta ed eliminazione Entry, Group e del Menu di visualizzazione.
    \item \textttt{Davide Cellot}: gestione generazione casuale password in fase di inserimento di una nuova 
...
autonomamente in locale. È stato impostato da tutti il comando \textttt{git config --global pull.rebase true} 
in modo che ad ogni \textttt{pull} venisse effettuato il \textttt{rebase} in automatico.
